...
namespace BFC_HappyPath
{
    ...
    {
        private readonly DesiredCapabilities _desiredCapabilities = new DesiredCapabilities();
        ...
        public IWebDriver CreateDriver(string browser, string version, string platform)
        {
            try
            {
                ...
                return new RemoteWebDriver(new Uri("http://localhost:4444/wd/hub"), _desiredCapabilities,
